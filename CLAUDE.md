...
- `/resume` → `/resume.pdf`
- `/code` → https://github.com/heresmohit
...
- Prettier for formatting; tests run in CI via `.github/workflows/content-validation.yml`
...
- The site is built as a static Astro site and can be deployed to GitHub Pages
